...
export function buildIntelligenceDraft(person,raw,sharedContext={},algorithmVersion='JCS_INTELLIGENCE_V1'){
  ...
  const intelligenceV2=buildDiagnosisAndPrescription(person,{newsNarrative,cohorts,competitors,snapshot:raw?.snapshotId||safeText(raw?.collectedAt).slice(0,10),algorithmVersion});
  return {
