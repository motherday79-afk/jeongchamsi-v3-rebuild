...
export function buildIntelligenceDraft(person,raw,sharedContext={},algorithmVersion='JCS_INTELLIGENCE_V1'){
  ...
  return {
    ...
    policies:issues.slice(0,3).map(issue=>issue.title),news:newsRows,newsNarrative,eventClusters,politicalAssetMatrix,pastPresentConnections,politicianType,sources,related,...intelligenceV2
  };
}
