...
export function publicQuests(s,now){
 ...
 return {day,autoStart,collect,valley,forest,eye,completed:Number(autoStart===1)+Number(collect===5)+Number(raid)+Number(valley)+Number(forest)+Number(eye),total:6};
}
