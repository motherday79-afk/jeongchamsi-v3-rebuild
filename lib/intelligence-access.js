...
const DIAGNOSIS_FIELDS=Object.freeze({
  public:['id','title','headline','currentPosition','coreEvent','politicalMeaning','attentionQuality','score','trend','visualization','updatedAt'],
  member:['id','title','headline','currentPosition','coreEvent','politicalMeaning','changeReason','pastPresentConnection','supportingData','attentionQuality','score','percentile','trend','benchmark','visualization','interpretation','evidence','sourceTypes','updatedAt','algorithmVersion','basis'],
  admin:['id','title','headline','currentPosition','coreEvent','politicalMeaning','changeReason','pastPresentConnection','supportingData','attentionQuality','score','percentile','trend','benchmark','visualization','interpretation','evidence','opportunity','risk','sourceTypes','updatedAt','algorithmVersion','basis']
});
const PRESCRIPTION_FIELDS=['id','linkedDiagnosisIds','diagnosisBasis','title','objective','strategicJudgment','actions','target','messageDirection','channels','timing','priority','expectedImpact','monitoringIndicators','visualization','updatedAt','algorithmVersion'];
