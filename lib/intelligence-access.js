...
const DISPLAY_KEYS=new Set(['kind','id','nowSignal','indicators','search','pc','mobile','mobileShare','news','pastRisks','tag','title','url','date','totalSign','risk','opportunity','cohorts','age','male','female','maleShare','femaleShare','maleContribution','femaleContribution','maleRank','femaleRank','total','composition','key','label','value','elections','status','population','populationBasis','populationStatus','issues','count','share','evidence','messageFit','localShare','messageShare','gap','people','name','party','office','region','overallRank','categoryRank','newsCount','sourceCount','frames','positive','neutral','negative','metrics','direction','velocity','persistence','from','to','durationDays','recurrences','reignitionCount','events','source','articleCount','sourceSpread','concentration','ownership','led','external','agendaPenetration','agendas','articles','outlets','policies','stage','stageIndex','specificity','beneficiary','budget','deadline','owner','opponent','opponentRate','voteRate','margin','result','year','election','regions','totalScore','gender','support','resilience','mediaInfluence','media']);
