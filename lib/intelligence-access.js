...
const DISPLAY_KEYS=new Set(['kind','id','mode','nowSignal','indicators','search','pc','mobile','mobileShare','news','pastRisks','tag','title','url','date','totalSign','risk','opportunity','cohorts','age','male','female','maleShare','femaleShare','maleContribution','femaleContribution','maleRank','femaleRank','total','composition','key','label','value','unit','basis','interpretation','elections','status','profileOnly','population','populationBasis','populationStatus','issues','count','share','evidence','messageFit','localShare','messageShare','gap','people','name','party','office','region','overallRank','categoryRank','newsCount','sourceCount','frames','positive','neutral','negative','metrics','competition','direction','velocity','persistence','from','to','durationDays','recurrences','reignitionCount','events','daily','index','offset','maxDaily','source','articleCount','sourceSpread','frequencyBands','repeat','double','single','topSources','remainingSources','concentration','ownership','led','external','agendaPenetration','agendas','articles','outlets','policies','stage','stageIndex','isPolicy','evidenceTitle','evidenceUrl','evidenceSource','specificity','beneficiary','budget','deadline','owner','opponent','opponentRate','voteRate','margin','result','year','election','regions','currentSignals','trajectory','regionalStructure','totalScore','gender','support','resilience','mediaInfluence','media']);
