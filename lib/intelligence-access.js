...
const DISPLAY_KEYS=new Set(['kind','nowSignal','indicators','search','pc','mobile','mobileShare','news','pastRisks','tag','title','url','date','totalSign','risk','opportunity','cohorts','age','male','female','maleRank','femaleRank','total','composition','key','label','value','elections','status','population','populationStatus','issues','count','share','messageFit','localShare','messageShare','people','name','party','office','region','overallRank','categoryRank','newsCount','sourceCount','frames','positive','neutral','negative','metrics','direction','velocity','persistence','from','to','recurrences','events','source','articleCount','sourceSpread','concentration','ownership','led','external','agendaPenetration','articles','outlets','policies','stage','specificity','beneficiary','budget','deadline','owner','opponent','opponentRate','voteRate','margin','result','year','election','regions','totalScore','gender','support','resilience','mediaInfluence','media']);
