...
const DISPLAY_KEYS=new Set(['kind','id','mode','nowSignal','indicators','search','pc','mobile','mobileShare','news','newsPeriods','periods','pastRisks','tag','title','url','date','totalSign','risk','opportunity','cohorts','age','male','female','maleShare','femaleShare','maleContribution','femaleContribution','maleRank','femaleRank','total','totalShare','composition','key','label','value','unit','basis','interpretation','elections','status','profileOnly','population','populationBasis','populationStatus','issues','count','share','evidence','messageFit','messagePath','localJudgment','localShare','messageShare','gap','people','name','party','office','region','overallRank','categoryRank','newsCount','sourceCount','frames','positive','neutral','negative','metrics','competition','direction','velocity','persistence','from','to','durationDays','recurrences','reignitionCount','events','daily','index','offset','maxDaily','source','articleCount','sourceSpread','allSources','majorOutletNames','majorShare','nonMajorShare','frequencyBands','repeat','double','single','topSources','remainingSources','concentration','ownership','led','external','agendaPenetration','agendas','articles','outlets','youtube','policies','stage','stageIndex','isPolicy','evidenceTitle','evidenceUrl','evidenceSource','specificity','beneficiary','budget','deadline','owner','opponent','opponentRate','voteRate','margin','result','year','election','regions','currentSignals','trajectory','regionalStructure','foundations','visual','activityCount','activities','category','frame','agency','initiative','firstMover','joined','conversion','agendaConversion','sourceIds','sourceId','items','detail','totalScore','gender','support','resilience','mediaInfluence','media']);
