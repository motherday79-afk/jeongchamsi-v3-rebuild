...
function displayContract(id,ctx,input,diagnosisScores){
  ...
  const messagePath=[{key:'voter',label:'지역 유권자 기반',value:regionalBase},{key:'visibility',label:'지역 의제 노출',value:localVisibility},{key:'connection',label:'정치인 메시지 연결',value:messageConnection}];
