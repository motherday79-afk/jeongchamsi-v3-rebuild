...
const MAJOR_OUTLET_NAMES=Object.freeze(['조선일보','중앙일보','동아일보','한겨레','경향신문']);
...
function normalizedOutlet(value){
  ...
  return !name||DISTRIBUTION_DOMAINS.test(name)?'':name;
}
