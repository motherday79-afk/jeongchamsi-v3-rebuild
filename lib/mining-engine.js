...
export const MINING_VERSION=281;
...
export function publicMine(s,now){
 ...
 return {gold,ore,pick,worker,storage,character,chosen,tool,cycle,claims,totalGold,cursor,lastStrike,costumes:s.costumes||{},campaignId:s.campaignId,paidPicks:s.paidPicks||[],mode:online?(s.presence.running?'player':'ready'):'offline',onlineToken:online?s.presence.token:null,onlineUntil:online?s.presence.until:0,serverNow:now,stats:mineStats(s)};
}
