...
export function buildMediaIndex(drafts=[],profiles=[]){
 ...
 return {version:MEDIA_INDEX_VERSION,people,articles:rows,issues:clusterArticles(rows,people),publishers:[...publishers].sort((a,b)=>a.localeCompare(b,'ko')),coverage};
}
