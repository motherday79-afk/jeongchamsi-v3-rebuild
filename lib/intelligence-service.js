...
export function createIntelligenceService(options={}){
  ...
  async function finalizePublication(job){
    ...
    try{
      ...
      await repository.updateVersion(job.snapshotId,{status:'published',reviewStatus:'approved',publishedAt:now(),replacedVersionId:previous||null,rankingWeights});
