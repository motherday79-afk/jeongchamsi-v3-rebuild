...
export const TARGET_KEYS = {
  ...
  politicianPhotoOverrides: 'jcsr2:politician-photo-overrides:v1',
  politicianMigration: 'jcsr2:politician-migration:v1',
  adminPoliticianRecords: 'jcsr2:admin-politician-records:v1',
  homeBanner: 'jcsr2:home-banner:v1',
  footerInfo: 'jcsr2:footer-info:v1',
  adminAudit: 'jcsr2:admin-audit:v1',
  politicianRequests: 'jcsr2:politician-requests:v1',
  partnerApplications: 'jcsr2:partner-applications:v1',
  inquiry: inquiryId => `jcsr2:inquiry:v1:${String(inquiryId||'').slice(0,80)}`,
  inquiryIndexAll: 'jcsr2:inquiry-index:v1:all',
  inquiryIndexPublic: 'jcsr2:inquiry-index:v1:public',
  inquiryIndexUser: userId => `jcsr2:inquiry-index:v1:user:${String(userId||'').slice(0,24)}`
};
