import { SERVICE_CATALOG, serviceIconSvg } from '../ui/service-icons.js?v=0.0.31.36';
...
const FOOTER_FIELDS=Object.freeze([
  ['businessName','운영·사업자명'],['businessRegistrationNumber','사업자등록번호'],['mailOrderRegistrationNumber','통신판매업 신고번호'],['representative','대표자'],['phone','대표전화'],['address','주소'],['privacyOfficer','개인정보 보호책임자'],['privacyEmail','개인정보 문의'],['adEmail','광고 문의'],['customerEmail','고객센터'],['partnerEmail','파트너 문의'],['managementEmail','경영지원 문의']
]);
