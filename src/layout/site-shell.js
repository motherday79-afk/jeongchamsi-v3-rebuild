...
export function drawer(session={authenticated:false,user:null}){
  ...
  return `<div class="drawer-backdrop" data-drawer-close hidden></div><aside class="app-drawer" data-drawer hidden aria-hidden="true" aria-label="정참시 전체 메뉴"><div class="drawer-head"><div><span>JEONGCHAMSI</span><b>정참시 전체메뉴</b></div><button type="button" aria-label="전체 메뉴 닫기" data-drawer-close>×</button></div>${account}<section class="drawer-block drawer-service-block"><div class="drawer-block-head"><b>전체 서비스</b><span>정참시 서비스 메뉴</span></div><div class="drawer-service-grid">${services}</div></section>${personal}<section class="drawer-block drawer-utility"><div class="drawer-utility-links">${adminLink}<a href="#/about" data-layout-route="/about">정참시 소개</a><a href="#/guide" data-layout-route="/guide">이용안내</a><a href="#/inquiry" data-layout-route="/inquiry">1:1 문의하기</a><a href="#/privacy" data-layout-route="/privacy">개인정보처리방침</a><a href="#/policy" data-layout-route="/policy">운영정책</a><a href="#/request-politician" data-layout-route="/request-politician">정치인 등록 요청</a><a href="#/partners" data-layout-route="/partners">파트너스 신청</a></div></section></aside>`;
}
export function footer(){return `<footer class="footer"><div><b>정참시</b><span>정치에 참여할 시간</span></div><nav class="footer-links"><a href="#/guide" data-layout-route="/guide">이용안내</a><a href="#/inquiry" data-layout-route="/inquiry">1:1 문의하기</a><a href="#/privacy" data-layout-route="/privacy">개인정보처리방침</a><a href="#/policy" data-layout-route="/policy">운영정책</a></nav></footer>`;}
