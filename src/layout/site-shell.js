...
export function fontSizeControl(){
  return `<div class="jcs-font-scale-bar"><div class="jcs-font-scale-control" data-font-scale-control data-font-scale="0" role="group" aria-label="페이지 글자 크기"><span>글자 크기</span><button type="button" data-font-scale-decrease aria-label="글자 크기 줄이기" disabled>−</button><output data-font-scale-level>기본</output><button type="button" data-font-scale-increase aria-label="글자 크기 키우기">＋</button></div></div>`;
}
