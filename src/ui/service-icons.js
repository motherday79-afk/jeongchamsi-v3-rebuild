export const SERVICE_CATALOG = Object.freeze([
  ...
  { key:"groups", tone:"navy", label:"정참시 모임", shortLabel:"모임", description:"관심사가 같은 사람들과 함께하는 공간", href:"/groups", launcher:false },
...
const ICON_PATHS=Object.freeze({
 groups:`<circle cx="12" cy="7" r="3"/><circle cx="5" cy="10" r="2"/><circle cx="19" cy="10" r="2"/><path d="M7 21v-4a5 5 0 0 1 10 0v4M2 20v-3a3 3 0 0 1 3-3M22 20v-3a3 3 0 0 0-3-3"/>`,
