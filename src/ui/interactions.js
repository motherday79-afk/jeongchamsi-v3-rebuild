import { renderPrescriptionReport } from '../views/prescription-visuals.js?v=0.0.31.55';
import { refreshFontScale, setupFontScaleControl } from './font-scale.js?v=0.0.31.55';
