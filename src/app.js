...
import { renderHomeLayout } from './layout/home-layout.js?v=0.0.23';
...
import { buildRoleNarratives } from './ui/intelligence-narratives.js?v=0.0.23';
import * as views from './views/stage1.js';
import { renderPoliticianDirectory, renderPoliticianDetail } from './views/politicians.js?v=0.0.23';
import { renderPoliticianCompare } from './views/politician-compare.js?v=0.0.23';
