...
import { setupLayoutInteractions } from './ui/interactions.js?v=0.0.31.18';
...
import * as views from './views/stage1.js?v=0.0.31.18';
import { renderPoliticianDirectory, renderPoliticianDetail } from './views/politicians.js?v=0.0.31.18';
import { renderPoliticianCompare } from './views/politician-compare.js?v=0.0.31.18';
