import { HOME_FIXTURE } from './fixtures/home.js?v=0.0.31.45';
import { siteHeader, drawer, footer, renderInitialLoading } from './layout/site-shell.js?v=0.0.31.45';
import { renderTrendingPage, renderKeywordsPage, renderNowRankCard, renderHomeLayout, renderBadgeShowcase } from './layout/home-layout.js?v=0.0.31.45';
import { setupLayoutInteractions } from './ui/interactions.js?v=0.0.31.45';
import { createAuthService, photoUploadMessage } from './core/auth.js?v=0.0.31.45';
import { createContentService } from './core/content.js?v=0.0.31.45';
import { createPoliticianService } from './core/politicians.js?v=0.0.31.45';
import { createNavigation, adminRouteState, adminRouteWith } from './core/navigation.js?v=0.0.31.45';
import { createIntelligenceAutoResumeGuard, runIntelligenceAction } from './core/intelligence-runner.js?v=0.0.31.45';
import { buildRoleNarratives } from './ui/intelligence-narratives.js?v=0.0.31.45';
import * as views from './views/stage1.js?v=0.0.31.45';
import { renderPoliticianDirectory, renderPoliticianDetail } from './views/politicians.js?v=0.0.31.45';
import { renderPoliticianCompare } from './views/politician-compare.js?v=0.0.31.45';
import { generationVoteConfirmation, renderPollBoard, renderGenerationPresident, renderNationalEvaluationPage } from './views/participation-pages.js?v=0.0.31.45';
import { renderPresidentPage } from './views/president.js?v=0.0.31.45';
import { renderSearchPage } from './views/search-page.js?v=0.0.31.45';
import { loadRecentPoliticians, recordRecentPolitician } from './ui/recent-politicians.js?v=0.0.31.45';
import { regionDistrictOptions, regionSubdistrictOptions } from './data/korean-regions.js?v=0.0.31.45';
