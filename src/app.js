...
import { renderHomeLayout } from './layout/home-layout.js?v=0.0.12';
...
import { renderPoliticianDirectory, renderPoliticianDetail } from './views/politicians.js?v=0.0.12';
import { renderPoliticianCompare } from './views/politician-compare.js?v=0.0.12';
