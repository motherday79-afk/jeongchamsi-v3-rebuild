...
import { renderHomeLayout, renderBadgeShowcase } from './layout/home-layout.js?v=0.0.30.3';
...
import { createNavigation } from './core/navigation.js?v=0.0.30.3';
import { createIntelligenceAutoResumeGuard, runIntelligenceAction } from './core/intelligence-runner.js';
import { buildRoleNarratives } from './ui/intelligence-narratives.js?v=0.0.30.3';
import * as views from './views/stage1.js';
import { renderPoliticianDirectory, renderPoliticianDetail } from './views/politicians.js?v=0.0.30.3';
import { renderPoliticianCompare } from './views/politician-compare.js?v=0.0.30.3';
import { renderPollBoard, renderGenerationPresident, renderNationalEvaluationPage } from './views/participation-pages.js?v=0.0.30.3';
import { renderPresidentPage } from './views/president.js?v=0.0.30.3';
import { renderSearchPage } from './views/search-page.js?v=0.0.30.3';
import { loadRecentPoliticians, recordRecentPolitician } from './ui/recent-politicians.js?v=0.0.30.3';
