...
import { renderHomeLayout, renderBadgeShowcase } from './layout/home-layout.js?v=0.0.31.22';
import { setupLayoutInteractions } from './ui/interactions.js?v=0.0.31.22';
...
import * as views from './views/stage1.js?v=0.0.31.22';
import { renderPoliticianDirectory, renderPoliticianDetail } from './views/politicians.js?v=0.0.31.22';
import { renderPoliticianCompare } from './views/politician-compare.js?v=0.0.31.22';
