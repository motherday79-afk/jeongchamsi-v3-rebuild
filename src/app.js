...
import {createPoliMarbleClient} from './core/polimable-client.js?v=0.0.31.225';
import {renderPoliMarblePage} from './views/polimable-page.js?v=0.0.31.225';
import {bindPoliMarbleInteractions,hydratePoliMarble} from './ui/polimable-interactions.js?v=0.0.31.225';
