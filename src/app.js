import { renderCagePosts, renderCageArena, renderCageHits, cagePageData } from './views/community-ui.js?v=0.0.31.66';
...
import * as views from './views/stage1.js?v=0.0.31.66';
