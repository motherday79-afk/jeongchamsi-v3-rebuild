import { campaignUrl, campaignVideoId } from '../core/campaign-model.js?v=0.0.31.158';
...
export function renderCampaignDetail(item,session={}){
  ...
  const support=item.support||{},official=campaignUrl(support.officialUrl),supportSource=campaignUrl(support.sourceUrl),showSupport=item.isExample!==true&&category==='politics'&&item.state!=='archive'&&support.public===true&&support.verified===true&&official&&supportSource&&support.associationName;
