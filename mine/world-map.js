export const worldMapMarkup=()=>`<section class="mine-world" data-world hidden aria-label="월드맵">
 ...
 <header class="world-header"><button data-world-home aria-label="광산으로 돌아가기">‹ <span>광산으로</span></button><h2>월드맵</h2></header>
 ...
 <button class="world-quest" data-panel="quests" aria-label="오늘의 퀘스트 자세히 보기"><strong><span class="world-quest-title">오늘의 퀘스트</span> <span data-world-progress>0 / 1</span></strong><p data-world-description>진행률 00%</p></button>
 </section>`;
export function updateWorldMap(root,raid){
 ...
 root.querySelector('[data-world-description]').textContent=`진행률 ${complete?'100':'00'}%`;
