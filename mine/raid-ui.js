...
export function animateRaid(host,result,{onNext,audio}){
 ...
 game.querySelector('[data-game-story]')?.setAttribute('hidden','');game.classList.add('raid-revealing');dialog?.classList.add('raid-cinema-dialog');
