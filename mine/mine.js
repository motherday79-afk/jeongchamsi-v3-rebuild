...
import {createMineAudio,soundButton,musicScene,pickSoundName} from './audio.js?v=324';
import {createMineNavigation} from './navigation.js?v=324';
import {worldMapMarkup,updateWorldMap,questMarkup} from './world-map.js?v=324';
...
function renderNavigation(which,scroll=0){
 ...
 if(!which||which==='world'){
  dialog.classList.remove('eye-screen','raid-screen','quest-screen','valley-screen','forest-screen');dialog.close();q('[data-world]').hidden=which!=='world';
