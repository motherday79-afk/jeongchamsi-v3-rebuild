...
import {makePickEffects} from './pick-effects.js?v=293';
import {renderIntegratedMiner} from './integrated-miner.js?v=293';
import {makeIdleNotice,setText} from './idle-state.js?v=280';
import {makeMinerMotion} from './motion.js?v=293';
