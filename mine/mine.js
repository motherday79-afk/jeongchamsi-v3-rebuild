import {forestMarkup,mountForest} from './forest.js?v=322';
import {setGameHeader} from './game-header.js?v=322';
import {valleyMarkup,mountValley} from './valley.js?v=320';
import {createMineAudio,soundButton,musicScene,pickSoundName} from './audio.js?v=322';
import {createMineNavigation} from './navigation.js?v=322';
import {worldMapMarkup,updateWorldMap,questMarkup} from './world-map.js?v=322';
...
function renderNavigation(which,scroll=0){
 ...
 if(!which||which==='world'){
  dialog.classList.remove('raid-screen','quest-screen','valley-screen','forest-screen');dialog.close();q('[data-world]').hidden=which!=='world';
