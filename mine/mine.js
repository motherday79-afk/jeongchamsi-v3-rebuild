...
const minerMotion=makeMinerMotion({setFrame:n=>{currentFrame=n;q('[data-player]').style.backgroundPosition=(n/7*100)+'% 0';if(state)renderPickDecoration(q('[data-pick-decoration]'),state,n);},impact:particles});
