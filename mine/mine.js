...
import {makePickEffects} from './pick-effects.js?v=295';
import {renderIntegratedMiner} from './integrated-miner.js?v=295';
import {makeIdleNotice,setText} from './idle-state.js?v=280';
import {makeMinerMotion} from './motion.js?v=295';
