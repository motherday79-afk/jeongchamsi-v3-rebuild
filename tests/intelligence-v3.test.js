...
test('compact storage keeps a small outlet frequency ledger for media reconstruction',()=>{
  ...
  assert.deepEqual(stored.input.news.sourceCounts,[{name:'대표 뉴스',count:2,h24:1,d7:2,d30:2},{name:'두번째 뉴스',count:1,h24:0,d7:1,d30:1},{name:'세번째 뉴스',count:1,h24:0,d7:1,d30:1}]);
});
